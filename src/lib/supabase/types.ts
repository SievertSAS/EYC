...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      conv_equipo_valores_base: {
        Row: {
          creado_en: string;
          deleted_at: string | null;
          di_base_217: number | null;
          di_base_29: number | null;
          di_base_60kv: number | null;
          di_base_70kv: number | null;
          di_base_80kv: number | null;
          di_base_cu1: number | null;
          di_base_cu2: number | null;
          di_base_cu3: number | null;
          dosis_base_columna_mgy: number | null;
          dosis_base_extremidades_mgy: number | null;
          dosis_base_torax_mgy: number | null;
          ei_base_217: number | null;
          ei_base_29: number | null;
          ei_base_60kv: number | null;
          ei_base_70kv: number | null;
          ei_base_80kv: number | null;
          ei_base_cu1: number | null;
          ei_base_cu2: number | null;
          ei_base_cu3: number | null;
          equipo_id: string;
          id: string;
          last_modified: string;
          mas_base_217: number | null;
          mas_base_60kv: number | null;
          mas_base_70kv: number | null;
          mas_base_80kv: number | null;
          mas_base_cu1: number | null;
          mas_base_cu2: number | null;
          mas_base_cu3: number | null;
          mtf20_base_horizontal: number | null;
          mtf20_base_vertical: number | null;
          mtf50_base_horizontal: number | null;
          mtf50_base_vertical: number | null;
          pka_base: number | null;
          sync_status: string;
        };
        Insert: {
          creado_en?: string;
        ...
        Relationships: [
          {
            foreignKeyName: "conv_equipo_valores_base_equipo_id_fkey";
            columns: ["equipo_id"];
            isOneToOne: true;
            referencedRelation: "equipos";
            referencedColumns: ["id"];
